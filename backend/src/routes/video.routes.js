...
import { getAllVideos,getVideoById,getVideoByCategory,getVideosByUser ,uploadVideo, updateVideo, deleteVideo,addAndRemoveLikes } from "../controllers/video.controller.js";
import { verifyJwtToken } from "../middlewares/auth.middleware.js";
const router = Router();

router.get('/', getAllVideos);
router.get('/:id', getVideoById);
router.post('/like/:id',verifyJwtToken,addAndRemoveLikes);

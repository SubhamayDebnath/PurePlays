...
const editComment = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, "Comment updated successfully", commentToUpdate));
});
...
const toggleLikeOnComment = asyncHandler(async (req, res) => {
    ...
    if(existingLike){
        ...
        return res.status(200).json(new ApiResponse(200, "Comment liked successfully", like));
    }
